 ...
 */
    ...
    Router::connect('/jijGroup/Template/Manager/Labels/Prints', array('controller' => 'Linnworksapis', 'action' => 'getPrints'));
    Router::connect('/jijGroup/Processing/Orders/OpenOrders/GetProcessed/Pdf', array('controller' => 'Linnworksapis', 'action' => 'getPdfOfOpenOrders'));    
