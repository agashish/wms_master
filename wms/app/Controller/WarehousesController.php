...
class WarehousesController extends AppController
{
    ...
    public function showallwarehouse()
    {
        ...
        /* Set conditions */
        $options = array(
            'fields' => array('State.state_name','Location.county_name','City.city_name','Warehouse.id','Warehouse.warehouse_name','Warehouse.status','WarehouseDesc.warehouse_id','WarehouseDesc.is_deleted'),
            'joins' => array(
                array(
                    'alias' => 'State',  
                    'table' => 'states',
