...
<head>
	...
	<!-- BEGIN CORE FRAMEWORK -->
        <?php print $this->html->css(array('plugins/bootstrap/css/bootstrap.min','plugins/ionicons/css/ionicons.min','plugins/font-awesome/css/font-awesome.min','plugins/bootstrap-select/css/bootstrap-select.min','plugins/bootstrapValidator/bootstrapValidator.min')); ?>
	<!-- END CORE FRAMEWORK -->
	
	<!-- BEGIN PLUGIN STYLES -->
        <?php print $this->html->css(array('plugins/animate/animate','plugins/datatables/dataTables.bootstrap','plugins/bootstrap-slider/css/slider','plugins/iCheck/skins/all','plugins/rickshaw/rickshaw.min','plugins/jquery-jvectormap/jquery-jvectormap-1.2.2','plugins/bootstrap-daterangepicker/daterangepicker-bs3')); ?>	
	<!-- END PLUGIN STYLES -->
...
<body class="fixed-leftside fixed-header sidebar-sm">
	...
	<!-- BEGIN CORE PLUGINS -->
        <?php print $this->html->script(array('plugins/jquery-1.11.1.min','plugins/iCheck/icheck.min','plugins/bootstrap/js/bootstrap.min','plugins/bootstrap/js/holder','plugins/pace/pace.min','plugins/slimScroll/jquery.slimscroll.min','plugins/bootstrap-select/js/bootstrap-select.min', 'plugins/bootstrapValidator/bootstrapValidator.min','plugins/bootstrap-modal-popover/bootstrap-modal-popover','core','custom','custom_datatable')); ?>
	<!-- END CORE PLUGINS -->
