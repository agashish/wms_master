                                    ...
                                    <div class="col-lg-8">                                            
                                        <?php
                                                if( count( $getCityList ) > 0 )
                                                    print $this->form->input( 'WarehouseDesc.city_id', array( 'type'=>'select', 'empty'=>'Choose City','options'=>$getCityList,'class'=>'form-control selectpicker','data-style'=>'btn-dropdown', 'div'=>false, 'label'=>false, 'required'=>false) );
                                        ?>  
                                    </div>
                                  </div>
								  <div class="form-group">
